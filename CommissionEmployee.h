...
#include <string> // classe string padrao C++
using std :: string;
...
public:
	...
	void setCommissionRate( double ); // configura a taxa de comissC#o (porcentagem)
	double getCommissionRate() const; // retorna a taxa de comissC#o
...
private:
	...
	double commissionRate; // porcentagem da comissC#o
